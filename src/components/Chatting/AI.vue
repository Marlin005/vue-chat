  ...
  <transition name="slide-right">
    <div class="chatting">
      ...
      <div class="chatting-input">
        <input @keyup.enter="send" v-model.trim="inputContent" placeholder="Chat with smart robots">
  ...
  data() {
    return {
      msgs: localStorage.msgs_ai && JSON.parse(localStorage.msgs_ai) || [
        // { date: '2019-10-04 09:57:08', from: 'marlin005', avatarUrl: `http://omratag7g.bkt.clouddn.com/icon-avatar${this.random(11)}.svg`, content: 'test', self: false}
      ],
      inputContent: '',
      oContent: {}
    }
