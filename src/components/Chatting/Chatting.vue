  ...
  <transition name="slide-left">
    <div class="chatting">
      ...
      <div class="chatting-input">
        ...
        <textarea @keyup.enter="send" @input="newLine" ref="textarea" v-model.trim="inputContent" placeholder="There is also a smart robot in the upper left corner."></textarea>
  ...
  data() {
    return {
      msgs: localStorage.msgs_group && JSON.parse(localStorage.msgs_group) || [
        // { date: '2019-10-49 09:57:08', loc: 'Oslo', from: 'marlin005', avatarUrl: ``, content: 'test', self: false}
      ],
      inputContent: '',
      oContent: {},
      oTextarea: {},
